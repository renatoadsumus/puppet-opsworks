...
#### DEFAULT USUARIO GO, NECESSIDADE QUANDO EXECUTAMOS O AGENT EM CONTAINER, PARA QUE O CONTAINER POSSA TER ACESSO NAS PASTAS DOS VOLUMES NO HOST, A COMUNNICAO ENTRE CONTAINER GO-AGENT E HOST É ATRAVES USUARIO "GO" SE O AGENT ESTIVER INSTALADO SERA RECEBIDO PELA CLASSE O USUARIO TFSSERVICE E GRUPO SUPORTE
